        ...
        <footer className="relative bg-gradient-to-br from-dark via-dark-lighter to-gray-900 py-12 overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                    ...
                    {/* Links Section */}
                    <div>
                        <h4 className="font-semibold mb-4 text-white bg-gradient-to-r from-green-400 to-blue-500 bg-clip-text text-transparent">
                            Links
                        </h4>
                        <ul className="space-y-3">
                            <li>
                                <a
                                    ...
                                    className="text-gray-300 hover:text-transparent hover:bg-gradient-to-r hover:from-green-400 hover:to-blue-500 hover:bg-clip-text text-sm transition-all duration-300 ease-in-out"
                                >
                                    Features
                                </a>
                            </li>
                            ...
                            <li>
                                <a
                                    href={isHomePage ? "#integrations" : "/#integrations"}
                                    className="text-gray-300 hover:text-transparent hover:bg-gradient-to-r hover:from-green-400 hover:to-blue-500 hover:bg-clip-text text-sm transition-all duration-300 ease-in-out"
                                >
                                    Integrations
                                </a>
                ...
                <div
                    ...
                    style={{
                        borderImage:
                            'linear-gradient(90deg, rgba(34, 197, 94, 0.2), rgba(59, 130, 246, 0.2), rgba(34, 197, 94, 0.2)) 1'
                    }}
                >
